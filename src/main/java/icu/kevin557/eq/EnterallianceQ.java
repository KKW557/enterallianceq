 ...
 * @author 557
 */
public abstract class EnterallianceQ {

    public static final String NAME = "EnterallianceQ";
    ...
    public String formatByMode(String translateKey, String mode) {
        return I18n.formatByMode(language, translateKey, mode);
    }
    ...
    public EnterallianceQ newInstance(long qq, byte[] password) throws InstantiationException, IllegalAccessException {
        EnterallianceQ bot = getClass().newInstance();
